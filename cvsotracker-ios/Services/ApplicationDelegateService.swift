//
//  ApplicationDelegateService.swift
//  Services
//
...
public protocol ApplicationDelegateService {
    ...
    func application(_ app: UIApplication, openURL url: URL, options: [String: Any]) -> Bool
    ...
    func handleActionWithIdentifierForRemoteNotification(_ application: UIApplication,
                                                         identifier: String?,
...
public extension ApplicationDelegateService {
    ...
    func handleActionWithIdentifierForRemoteNotification(_: UIApplication,
                                                         identifier _: String?,
